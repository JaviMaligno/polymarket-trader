-- Polymarket Trading System - Complete Database Initialization
-- Run this script on Timescale Cloud to set up all tables

-- Note: TimescaleDB extension is pre-enabled on Timescale Cloud
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'markets_updated_at') THEN
...
-- ============================================
-- CONTINUOUS AGGREGATES (Optional - run separately if needed)
-- ============================================
